...
Forked to use the Platinum Weather Card icons, fix/update icon choice (for example, being able to read 'partlycloudy' and 'partly cloudy' and to display a fog icon for 'fog' or 'foggy'). I prefer this card over the Platinum card because it can display more than a 5-day forcast horizontally (high temp above low temp instead of next to) and because the forecast shows "today".
